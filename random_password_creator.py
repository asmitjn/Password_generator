...
class Password:
    ...
    def generate_password(self):
        ...
        for i in range(self.length):
            outer_indx=random.randrange(0,len(self.char_array))
            inner_index=random.randrange(0,len(self.char_array[outer_indx]))
            self.password.append(self.char_array[outer_indx][inner_index])
